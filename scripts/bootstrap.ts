...
const FOUNDING_TEAM: {
  ...
  /**
   * **أدمنان مستقلّان: بلا مدير فوقهما وبلا أدمن تحتهما.**
   *
   * قالها أحمد بنصّه: «سارة أدمن مبيعات مستقل لا يتبع أحد في فرع الرياض»
   * و«محمد بكري أدمن مبيعات مستقل لا يتبع أحد في فرع مدينة نصر». والدور
   * `sales_admin` لا `sales_manager`: الاستقلال يقع بـ`reportsTo: null`،
   * وهو وحده ما يجعل الواحد منهما يستحقّ حصة الأدمن والمدير معًا (٥٪).
   * ودورُ المدير كان يفتح لهما لوحةَ فريقٍ من شخصٍ واحد.
   *
   * وعند انضمام أدمن إلى أحدهما يصير `reportsTo` للأدمن الجديد فتنطبق
   * القسمة المعتادة تلقائيًا — بلا تغيير في الكود.
   */
  {
    key: 'bakri',
    name: 'محمد بكري',
    ...
    branch: 'nasr_city',
    reportsTo: null,
    jobTitle: 'أدمن مبيعات مستقل — مدينة نصر',
  },
  {
    key: 'sara',
    name: 'سارة',
    email: 'sara@fasttrans.local',
    role: 'sales_admin',
    branch: 'riyadh',
    reportsTo: null,
    jobTitle: 'أدمن مبيعات مستقل — الرياض',
  },
