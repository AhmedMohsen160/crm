...
eq(
  parseArabicAmount(new Date('2535-08-15T00:00:00Z')),
  232157,
  '★ **ومبلغٌ وصل تاريخًا يُردّ رقمًا** — دفتر ٢٠٢٦ يحمل تنسيق تاريخ على عمود المدين، ولولا الردّ لسقط رصيدُ الافتتاح صفرًا'
);
eq(parseArabicAmount(new Date('1985-12-03T00:00:00Z')), 31384, 'ومبلغٌ أصغر كذلك');
