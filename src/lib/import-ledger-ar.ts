...
const TYPE_SOURCE: [string, string][] = [
  ...
  /**
   * **«تحويلات العملات» إيرادٌ آخر — كما صنّفها المحاسب في ورقته هو.**
   *
   * كانت تُقرأ أصلًا، ورصيدُها دائنٌ في كل السنوات (٦١٬٣٩١ في ٢٠٢٣ و١٧٨٬٧٤٠
   * في ٢٠٢٤). وعمودُ التوجيه في ميزان المراجعة يضعها في «الإيرادات الأخرى»
   * جنبًا إلى جنب مع فروق العملة — بخطّ المحاسب لا باجتهادنا.
   *
   * وقراءتُها أصلًا كانت تُخرج صافي الربح عن رقمه: ٩٢١٬٨٤٩ في ٢٠٢٣ والمحاسب
   * يقول ٩٨٣٬٢٤٠ — والفارق هو هي بالضبط.
   *
   * **ولا تدخل التسوية**: ربحُ صرفٍ لا مشترياتِ عميل، فتُستثنى بـ`isFxAccount`.
   */
  ['تحويلات العملات', 'revenue'],
