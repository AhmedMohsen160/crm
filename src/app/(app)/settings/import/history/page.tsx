...
/**
 * **والتسوية للفترات المقفلة — والحدُّ تاريخُ الوقف لا رأسُ السنة.**
 *
 * كانت مقصورةً على السنوات المنتهية لأن ٢٠٢٦ جاريةٌ يُدخل فيها الموظفون كل
 * يوم، وتوسيعُ مبالغ شهرٍ ما زال يُكتب فيه خطأٌ يتراكم. ثم أغلق أحمد الداتا
 * عند ٣١ يوليو ٢٠٢٦: «من أول أغسطس تكون مدخلات لاحقة». فصارت شهور يناير
 * حتى يوليو فترةً منتهيةً مرحَّلًا دفترُها كأي سنةٍ مقفلة.
 *
 * **والحارس في مكانين**: التسوية لا تتجاوز تاريخ الوقف (`until`)، والنسب
 * لا تُحسب على ما مسّته التسوية (`commissionableAmount`) — فلا يستحقّ أحدٌ
 * نسبةً على مالٍ نسبه النظام إليه ولم يبعه.
 */
const SETTLE_YEARS = '2022 2023 2024 2025 2026';
          ...
          <form method="post" action="/api/save" className="card">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <FormField
                ...
                dir="ltr"
                hint="والحدّ تاريخُ الوقف أدناه — لا يُسوَّى شهرٌ بعده"
              />
            </div>
            <AdvancedOwners
              userOptions={userOptions}
